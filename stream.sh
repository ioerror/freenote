...
#
# Assuming that you're authorized by the FSF - the video should be available here:
...
PASSWORD=GnUisL1ve # Replace this with the correct password, of course
LOCALIP=127.0.0.1
LOCALPORT=8080
...
# Audio and video streaming on Tor Hidden Service and streaming to FSF
 ...
 tee name=shout ! tee name=fileout ! tcpserversink  host=$LOCALIP port=$LOCALPORT shout. ! queue ! \
